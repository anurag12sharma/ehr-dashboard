...
export default function AppointmentsPage() {
  ...
  return (
    <div className="space-y-8 fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
        <div>
          <h1 className="text-3xl font-extrabold text-gray-900 mb-1">Appointments</h1>
          <p className="text-sm text-gray-500">
            Manage patient appointments and scheduling
          </p>
        </div>
        <button onClick={handleCreateAppointment} className="btn-main flex items-center gap-2">
  ...
  <div className="glass-panel card-hover flex items-center border-l-4 border-blue-500">
    ...
    <div>
      ...
      <div className="text-2xl font-semibold text-gray-900">{todaysAppointments}</div>
    </div>
  </div>
  ...
  <div className="glass-panel card-hover flex items-center border-l-4 border-purple-500">
    ...
    <div>
      ...
      <div className="text-2xl font-semibold text-gray-900">{bookedAppointments}</div>
    </div>
  </div>
  <div className="glass-panel card-hover flex items-center border-l-4 border-yellow-500">
    ...
    <div>
      ...
      <div className="text-2xl font-semibold text-gray-900">{pendingAppointments}</div>
    </div>
  </div>
</div>
    ...
    <div className="sm:w-48">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 flex flex-col items-center">
          ...
          <h3 className="mt-3 text-base font-semibold text-gray-900">No appointments found</h3>
